...
const translations = {
    ...
    // =========================================================================
    // 2. NAVIGATION & SIDEBAR / ナビゲーション
    // =========================================================================
    nav: {
        id: {
            brand_subtitle: 'ENGINE PARTS & AIR PUMP MFG',
            brand_system: 'PLANT-01 • MES STANDARD',
            section_operations: 'OPERASIONAL & INPUT',
            dashboard: 'Dashboard',
            daily_input: 'Input Laporan Harian',
            ng_input: 'Input Laporan NG',
            monitoring: 'Production Monitoring',
            section_analytics: 'ANALISIS & SPC',
            machine_perf: 'Machine Performance',
            line_perf: 'Production Lines',
            shift_team_perf: 'Shift & Team Perform',
            shift_perf: 'Shift Performance',
            team_perf: 'Team Performance',
            downtime_analysis: 'Downtime Analysis',
            quality_perf: 'Quality Performance',
            section_reports: 'MASTER & LAPORAN',
